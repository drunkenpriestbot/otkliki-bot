...
только по кнопке). Карточка содержит заголовок/описание/ссылку и кнопку
"Сгенерировать отклик" (кнопку "Удалить" убрали 04.07 — после regex-
префильтра мусорных карточек стало мало, чистить их вручную не нужно).
